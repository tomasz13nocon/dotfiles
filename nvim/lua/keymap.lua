...
vim.keymap.set('n', '<Leader>fh', require('telescope.builtin').help_tags) --'<cmd>Telescope help_tags<cr>')
vim.keymap.set('', 'J', '4j')
vim.keymap.set('', 'K', '4k')
vim.keymap.set('', '+', '"+y')
...
-- vim.keymap.set('n', '', ':lua vim.lsp.buf.signature_help()<CR>')
...
-- "<leader>gq" vim.lsp.buf.formatting_sync
